...
exports.newInstance = function($, spec, cb) {
     ...
     * @return {Array.<caf.notif>} A frozen array with a snapshot
     * of the output queue.
     *
    ...
    that.outq = function(optSessionId) {
        var session = $._.getSession(optSessionId);
     ...
     *        Array.<caf.json>
     *
     * @param {caf.notif} argsArray An array with the arguments
     * in the notification.
     * @param {string=} optSessionId An optional logical session name
     * identifying the output queue.
     *
     ...
     *
     *      {nonce: string, memento: caf.json=}
     *
     * @return {caf.sessionBegin} A unique instance
